      ...
      .box-formulario
        ...
        form(
          ...
          .row
            .col-12.col-sm-6
              k-select(
                ...
                :error='errors.first("formDatosDesembolso.tipoCuenta")'
                v-model.trim='formDatosDesembolso.tipoCuenta'
          ...
          .box-action
            ...
            k-button.btn-lg(type='submit' @click='continuar()') Continuar
</template>
...
<style lang="scss" scoped="">
  ...
  .page-datos-desembolso .container{
    padding: 0 5rem;
  }
  .page-datos-desembolso .container .box-barra{
    margin: 3rem 0;
  ...
  .page-datos-desembolso .container .box-barra .box-completed{
    position: absolute;
    left: 0;
    top: -5px;
  }
  .page-datos-desembolso .container h2{
    font-weight: bold;
    color: black;
    font-size: 1.5rem;
  }
  .page-datos-desembolso .box-formulario .box-action{
    margin-top: 5rem;
    display: flex;
    justify-content: space-between;
  }
  .page-datos-desembolso .box-formulario small{
    font-size: 0.9rem;
    font-weight: 100;
  }
</style>